...
function CartItems() {
    const {all_products, cartItems, removeFromCart, getTotalAmount} = UseShopContext();
                ...
                if(cartItems[e.id] > 0){
                    return<div key={e.id}>
                            <div className={`${styles.cartItems_format} ${styles.cartItems_format_main}`} >
                                ...
                                <img src={remove_icon} alt="" onClick={()=> {removeFromCart(e.id)}} className={styles.cartItems_remove_icon}/>
                            </div>
                            <hr />
                        </div>
                }
